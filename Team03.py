# -*- coding: utf-8 -*-
"""Machine Learning Baseline의 사본

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1cnkc8abje-5SJIDq5OH2PUsOypUQGuya
"""
...
!unzip '/content/drive/MyDrive/Colab Notebooks/merge.zip'
...
def eval():
    ...
    ################################################################
    test_dataset = TestImageFolder('./khu-machine-learning-competition/test', transform=test_transform)
    test_loader = DataLoader(test_dataset, batch_size=BATCHSIZE, num_workers=4, shuffle=False)

    model = PyramidNet()
    model = model.cuda()
    model.load_state_dict(torch.load(SAVEPATH+'fin_195_model_weight.pth'))
    model.eval()
